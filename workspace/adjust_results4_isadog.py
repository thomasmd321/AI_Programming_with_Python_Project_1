...
def adjust_results4_isadog(results_dic, dogfile):
    ...
    for key in results_dic:     
        ...
        #print("#Debug adjust_results# {} - {} - {} - {} - {}".format(results_dic[key][0], results_dic[key][1],results_dic[key][2],results_dic[key][3],results_dic[key][4]))
    #print("#Debug adjust_results - results_dic  {}".format(results_dic))            
